...
$("document").ready(function(){
  ...
  //another action --> click? or hover? <--- change the class for the line into two division and texts appear introducing myself)

  $( ".Line2" ).click(function() {

   $( "#clickline" ).hide(400, "easeOutBounce")
    $( "#textline1" ).hide(600, "easeOutBounce")
    $( "#h1" ).show(600, "easeOutBounce")
  
    $(".Intro").delay(400).show(1200)
  });

  $( ".Line3" ).click(function(){
    $( ".Line" ).show(400, "easeOutBounce")
    $(".Intro").hide(600, "easeOutBounce")
    $( "#h1" ).hide(600, "easeOutBounce")
    $( "#textline1" ).show(600, "easeOutBounce")
  });
 ...
 $(".Item").click(function(){
  ...
  $( "#Hi" ).click(function(){
    $(".Intro").hide(400, "easeOutBounce")
    $( "#h1" ).hide(400, "easeOutBounce")
    $( "#textline2" ).show(400, "easeOutBounce")
    $( "#textline1" ).show(400, "easeOutBounce")
  });

  $( ".Line2" ).click(function() {
     $( "#textline2" ).hide(400, "easeOutBounce")
     $( "#textline1" ).hide(600, "easeOutBounce")
     $(".Intro").delay(400).show(1200)
   });
